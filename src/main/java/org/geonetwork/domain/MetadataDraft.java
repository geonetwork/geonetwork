...
@Setter
@Entity
@Table(name = "metadatadraft")
public class MetadataDraft {
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "metadatadraft_id_gen")
    @SequenceGenerator(name = "metadatadraft_id_gen", sequenceName = "metadata_id_seq", allocationSize = 1)
    ...
    @JoinColumn(name = "approvedversion_id", nullable = false)
    private org.geonetwork.domain.Metadata approvedversion;
