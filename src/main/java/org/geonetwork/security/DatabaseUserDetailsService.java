...
public class DatabaseUserDetailsService extends AbstractUserDetailsAuthenticationProvider
  ...
  public DatabaseUserDetailsService(Boolean checkUsernameOrEmail, PasswordEncoder passwordEncoder, UserRepository userRepository, UsergroupRepository userGroupRepository) {
  ...
  protected UserDetails retrieveUser(String username,
    ...
    try {
      ...
      Map<String, List<Integer>> attributesToCast = userGroups.stream()
        .map(userGroup -> new AbstractMap.SimpleEntry<>(
