...
public class OgcApiRecordsGeometrycollectionGeoJSONDto implements OgcApiRecordsGeometryGeoJSONDto {
  ...
  @Valid private List<OgcApiRecordsGeometryGeoJSONDto> geometries = new ArrayList<>();
  ...
  public OgcApiRecordsGeometrycollectionGeoJSONDto(
      TypeEnum type, List<OgcApiRecordsGeometryGeoJSONDto> geometries) {
    this.type = type;
  ...
  public OgcApiRecordsGeometrycollectionGeoJSONDto geometries(
      List<OgcApiRecordsGeometryGeoJSONDto> geometries) {
    this.geometries = geometries;
    return this;
  }

  public OgcApiRecordsGeometrycollectionGeoJSONDto addGeometriesItem(
      OgcApiRecordsGeometryGeoJSONDto geometriesItem) {
  ...
  public String toString() {
    String sb =
        "class OgcApiRecordsGeometrycollectionGeoJSONDto {\n"
            + "    type: "
