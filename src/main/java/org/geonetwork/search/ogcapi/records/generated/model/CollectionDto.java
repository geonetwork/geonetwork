...
public class CollectionDto {
     ...
     */
    @NotNull
    @Schema(name = "id", example = "address", description = "identifier of the collection used, for example, in URIs", requiredMode = Schema.RequiredMode.REQUIRED)
    @JsonProperty("id")
    ...
    @Schema(name = "title", example = "address", description = "human readable title of the collection", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    @JsonProperty("title")
    ...
    @Schema(name = "description", example = "An address.", description = "a description of the features in the collection", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    ...
    @NotNull
    @Valid
    @Schema(name = "links", example = "[{href=http://data.example.com/buildings, rel=item}, {href=http://example.com/concepts/buildings.html, rel=describedby, type=text/html}]", requiredMode = Schema.RequiredMode.REQUIRED)
    @JsonProperty("links")
    ...
    @Schema(name = "itemType", description = "indicator about the type of the items in the collection (the default value is 'feature').", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    ...
    @Schema(name = "crs", example = "[http://www.opengis.net/def/crs/OGC/1.3/CRS84, http://www.opengis.net/def/crs/EPSG/0/4326]", description = "the list of coordinate reference systems supported by the service", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    @JsonProperty("crs")
