...
@JacksonXmlRootElement(localName = "ServerVariableDto")
@XmlRootElement(name = "ServerVariableDto")
...
public class ServerVariableDto {
     ...
     */
    public ServerVariableDto(String _default) {
    ...
    public ServerVariableDto _enum(List<String> _enum) {
        this._enum = _enum;
        return this;
    }

    public ServerVariableDto addEnumItem(String _enumItem) {
        if (this._enum == null) {
    ...
    public ServerVariableDto _default(String _default) {
        this._default = _default;
        return this;
    }
    ...
    public ServerVariableDto description(String description) {
    ...
    public boolean equals(Object o) {
        ...
        ServerVariableDto serverVariable = (ServerVariableDto) o;
    ...
    public String toString() {
        String sb = "class ServerVariableDto {\n" +
    ...
    public static class Builder {
        ...
        private ServerVariableDto instance;

        public Builder() {
            this(new ServerVariableDto());
        }

        protected Builder(ServerVariableDto instance) {
            this.instance = instance;
        }

        protected Builder copyOf(ServerVariableDto value) {
        ...
        /**
         * returns a built ServerVariableDto instance.
         * <p>
         * The builder is not reusable (NullPointerException)
         */
        public ServerVariableDto build() {
            try {
