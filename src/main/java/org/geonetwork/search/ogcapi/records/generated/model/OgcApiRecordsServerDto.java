...
public class OgcApiRecordsServerDto {
  ...
  @Valid private Map<String, OgcApiRecordsServerVariableDto> variables = new HashMap<>();
  ...
  public OgcApiRecordsServerDto putVariablesItem(
      String key, OgcApiRecordsServerVariableDto variablesItem) {
