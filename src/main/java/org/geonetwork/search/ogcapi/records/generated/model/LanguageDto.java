...
public class LanguageDto {
     ...
     */
    @NotNull
    @Schema(name = "code", example = "el", description = "The language tag as per RFC-5646.", requiredMode = Schema.RequiredMode.REQUIRED)
    @JsonProperty("code")
     ...
     */
    @Size(min = 1)
    @Schema(name = "name", example = "Ελληνικά", description = "The untranslated name of of the language.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    @JsonProperty("name")
    ...
    @Schema(name = "alternate", example = "Greek", description = "The name of the language in another well-understood language, usually English.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    ...
    public String toString() {
        String sb = "class LanguageDto {\n" +
            "    code: " + toIndentedString(code) + "\n" +
            "    name: " + toIndentedString(name) + "\n" +
            "    alternate: " + toIndentedString(alternate) + "\n" +
