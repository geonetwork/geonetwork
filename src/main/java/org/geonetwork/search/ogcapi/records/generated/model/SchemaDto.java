...
@Schema(name = "schema", description = "The description of OpenAPI v3.0.x documents, as defined by https://spec.openapis.org/oas/v3.0.3")
@JsonTypeName("schema")
...
public class SchemaDto {
    ...
    @Valid
    private List<@Valid ServerDto> servers = new ArrayList<>();

    @Valid
    private List<SecurityRequirementDto> security = new ArrayList<>();

    @Valid
    private Set<@Valid TagDto> tags = new LinkedHashSet<>();
    ...
    public String toString() {
        String sb = "class SchemaDto {\n" +
            "    openapi: " + toIndentedString(openapi) + "\n" +
