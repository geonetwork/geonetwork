...
public class OgcApiRecordsGetRecords200ResponseDto {
  ...
  @Valid private List<@Valid OgcApiRecordsRecordGeoJSONDto> features = new ArrayList<>();
  ...
  public OgcApiRecordsGetRecords200ResponseDto(
      TypeEnum type, List<@Valid OgcApiRecordsRecordGeoJSONDto> features) {
    this.type = type;
  ...
  public OgcApiRecordsGetRecords200ResponseDto features(
      List<@Valid OgcApiRecordsRecordGeoJSONDto> features) {
    this.features = features;
    return this;
  }

  public OgcApiRecordsGetRecords200ResponseDto addFeaturesItem(
      OgcApiRecordsRecordGeoJSONDto featuresItem) {
  ...
  public OgcApiRecordsGetRecords200ResponseDto linkTemplates(
      List<OgcApiRecordsLinkTemplateDto> linkTemplates) {
    this.linkTemplates = linkTemplates;
    return this;
  }

  public OgcApiRecordsGetRecords200ResponseDto addLinkTemplatesItem(
  ...
  public boolean equals(Object o) {
    ...
    OgcApiRecordsGetRecords200ResponseDto getRecords200Response =
        (OgcApiRecordsGetRecords200ResponseDto) o;
  ...
  public int hashCode() {
    return Objects.hash(
        type, features, links, timeStamp, numberMatched, numberReturned, linkTemplates);
  }

  @Override
  public String toString() {
    String sb =
        "class OgcApiRecordsGetRecords200ResponseDto {\n"
            + "    type: "
