...
public class RecordCommonPropertiesDto {
    ...
    public RecordCommonPropertiesDto externalIds(List<@Valid RecordCommonPropertiesExternalIdsInnerDto> externalIds) {
        this.externalIds = externalIds;
        return this;
    }

    public RecordCommonPropertiesDto addExternalIdsItem(RecordCommonPropertiesExternalIdsInnerDto externalIdsItem) {
    ...
    public String toString() {
        String sb = "class RecordCommonPropertiesDto {\n" +
