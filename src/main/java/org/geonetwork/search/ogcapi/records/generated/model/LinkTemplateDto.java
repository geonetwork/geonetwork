...
public class LinkTemplateDto {
    ...
    @Schema(name = "rel", example = "alternate", description = "The type or semantics of the relation.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    @JsonProperty("rel")
    ...
    @Schema(name = "type", example = "application/geo+json", description = "A hint indicating what the media type of the result of dereferencing the link should be.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    @JsonProperty("type")
    ...
    @Schema(name = "hreflang", example = "en", description = "A hint indicating what the language of the result of dereferencing the link should be.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    ...
    @Schema(name = "title", example = "Trierer Strasse 70, 53115 Bonn", description = "Used to label the destination of a link such that it can be used as a human-readable identifier.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    @JsonProperty("title")
     ...
     */
    @Valid
    @Schema(name = "created", description = "Date of creation of the resource pointed to by the link.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
     ...
     */
    @Valid
    @Schema(name = "updated", description = "Most recent date on which the resource pointed to by the link was changed.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
     ...
     */
    @NotNull
    @Schema(name = "uriTemplate", example = "http://data.example.com/buildings/(building-id}", description = "Supplies a resolvable URI to a remote resource (or resource fragment).", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(name = "varBase", description = "The base URI to which the variable name can be appended to retrieve the definition of the variable as a JSON Schema fragment.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    ...
    @Schema(name = "variables", description = "This object contains one key per substitution variable in the templated URL.  Each key defines the schema of one substitution variable using a JSON Schema fragment and can thus include things like the data type of the variable, enumerations, minimum values, maximum values, etc.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(rel, type, hreflang, title, length, created, updated, uriTemplate, varBase, variables);
    }

    @Override
    public String toString() {
        String sb = "class LinkTemplateDto {\n" +
            ...
            "    uriTemplate: " + toIndentedString(uriTemplate) + "\n" +
            "    varBase: " + toIndentedString(varBase) + "\n" +
