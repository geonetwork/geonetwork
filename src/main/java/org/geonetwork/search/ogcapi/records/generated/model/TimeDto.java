...
public class TimeDto implements RecordGeoJSONTimeDto {
    ...
    @Valid
    private List<TimeIntervalInnerDto> interval = new ArrayList<>();
    ...
    @Schema(name = "resolution", example = "[P1D]", description = "Minimum time period resolvable in the dataset, as an ISO 8601 duration", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
