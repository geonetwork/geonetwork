...
import org.geonetwork.search.ogcapi.records.generated.model.Catalog1Dto;
...
import org.geonetwork.search.ogcapi.records.generated.model.SchemaDto;
        ...
        @ApiResponse(
            ...
            content = {
              @Content(
                  ...
                  schema = @Schema(implementation = Catalog1Dto.class)),
              @Content(
                  mediaType = "text/html",
                  schema = @Schema(implementation = Catalog1Dto.class))
            }),
      ...
      responses = {
        @ApiResponse(
            ...
            content = {
              @Content(
                  mediaType = "application/json",
                  schema = @Schema(implementation = GetCollections200ResponseDto.class)),
              @Content(
                  mediaType = "text/html",
                  schema = @Schema(implementation = GetCollections200ResponseDto.class))
            }),
        ...
        @ApiResponse(
            ...
            content = {
              @Content(
                  ...
                  schema = @Schema(implementation = RecordGeoJSONDto.class)),
              @Content(
                  mediaType = "text/html",
                  schema = @Schema(implementation = RecordGeoJSONDto.class)),
              @Content(
      ...
      responses = {
        @ApiResponse(
            ...
            content = {
              @Content(
                  mediaType = "application/geo+json",
                  schema = @Schema(implementation = GetRecords200ResponseDto.class)),
              @Content(
                  mediaType = "text/html",
                  schema = @Schema(implementation = GetRecords200ResponseDto.class)),
              @Content(
      ...
      responses = {
        @ApiResponse(
            ...
            content = {
              @Content(
                  mediaType = "application/json",
                  schema = @Schema(implementation = SchemaDto.class)),
