...
@JacksonXmlRootElement(localName = "LinestringGeoJSONDto")
@XmlRootElement(name = "LinestringGeoJSONDto")
...
public class LinestringGeoJSONDto implements GeometryGeoJSONDto {
     ...
     */
    public LinestringGeoJSONDto(TypeEnum type, List<List<BigDecimal>> coordinates) {
        this.type = type;
    ...
    public LinestringGeoJSONDto coordinates(List<List<BigDecimal>> coordinates) {
        this.coordinates = coordinates;
        return this;
    }

    public LinestringGeoJSONDto addCoordinatesItem(List<BigDecimal> coordinatesItem) {
    ...
    public String toString() {
        String sb = "class LinestringGeoJSONDto {\n" +
    ...
    public static class Builder {
        ...
        private LinestringGeoJSONDto instance;

        public Builder() {
            this(new LinestringGeoJSONDto());
        }

        protected Builder(LinestringGeoJSONDto instance) {
            this.instance = instance;
        }

        protected Builder copyOf(LinestringGeoJSONDto value) {
        ...
        /**
         * returns a built LinestringGeoJSONDto instance.
         * <p>
         * The builder is not reusable (NullPointerException)
         */
        public LinestringGeoJSONDto build() {
            try {
