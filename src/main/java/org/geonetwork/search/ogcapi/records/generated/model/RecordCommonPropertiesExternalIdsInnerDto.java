...
public class RecordCommonPropertiesExternalIdsInnerDto {
  ...
  @Schema(
      name = "scheme",
      description =
          "A reference to an authority or identifier for a knowledge organization system from which"
  ...
  public boolean equals(Object o) {
    ...
    RecordCommonPropertiesExternalIdsInnerDto recordCommonPropertiesExternalIdsInner =
        (RecordCommonPropertiesExternalIdsInnerDto) o;
  ...
  public String toString() {
    String sb =
        "class RecordCommonPropertiesExternalIdsInnerDto {\n"
            + "    scheme: "
