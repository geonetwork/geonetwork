...
public class OgcApiRecordsLandingPageDto {
  ...
  @Schema(
      name = "description",
      example =
          "Access to data about buildings in the city of Bonn via a Web API that conforms to the"
  ...
  public OgcApiRecordsLandingPageDto linkTemplates(
      List<OgcApiRecordsLinkTemplateDto> linkTemplates) {
    this.linkTemplates = linkTemplates;
    return this;
  }

  public OgcApiRecordsLandingPageDto addLinkTemplatesItem(
  ...
  public String toString() {
    String sb =
        "class OgcApiRecordsLandingPageDto {\n"
            + "    title: "
