...
public class ThemeDto {
    ...
    @Valid
    private List<@Valid ThemeConceptsInnerDto> concepts = new ArrayList<>();
    ...
    @Valid
    @Size(min = 1)
    @Schema(name = "concepts", description = "One or more entity/concept identifiers from this knowledge system. it is recommended that a resolvable URI be used for each entity/concept identifier.", requiredMode = Schema.RequiredMode.REQUIRED)
     ...
     */
    @NotNull
    @Schema(name = "scheme", description = "An identifier for the knowledge organization system used to classify the resource.  It is recommended that the identifier be a resolvable URI.  The list of schemes used in a searchable catalog can be determined by inspecting the server's OpenAPI document or, if the server implements CQL2, by exposing a queryable (e.g. named `scheme`) and enumerating the list of schemes in the queryable's schema definition.", requiredMode = Schema.RequiredMode.REQUIRED)
    @JsonProperty("scheme")
    ...
    public String toString() {
        String sb = "class ThemeDto {\n" +
            "    concepts: " + toIndentedString(concepts) + "\n" +
