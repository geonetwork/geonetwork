...
public class GdalBandDto {
  ...
  public int hashCode() {
    return Objects.hash(
        name, commonName, description, centerWavelength, fullWidthHalfMax, solarIllumination);
  }
  ...
  public String toString() {
    ...
    sb.append("    solarIllumination: ").append(toIndentedString(solarIllumination)).append("\n");
    sb.append("}");
    return sb.toString();
  }
