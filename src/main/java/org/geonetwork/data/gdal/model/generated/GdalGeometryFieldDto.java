...
public class GdalGeometryFieldDto {
  ...
  @Valid private List<BigDecimal> extent = new ArrayList<>();

  @Valid private List<GdalGeometryFieldExtent3DInnerDto> extent3D = new ArrayList<>();

  private JsonNullable<GdalCoordinateSystemDto> coordinateSystem =
      JsonNullable.<GdalCoordinateSystemDto>undefined();
  ...
  public GdalGeometryFieldDto supportedSRSList(
      List<GdalGeometryFieldSupportedSRSListInnerDto> supportedSRSList) {
  ...
  public void setSupportedSRSList(
      List<GdalGeometryFieldSupportedSRSListInnerDto> supportedSRSList) {
    this.supportedSRSList = supportedSRSList;
  }
  ...
  public int hashCode() {
    return Objects.hash(
        ...
        extent,
        extent3D,
        hashCodeNullable(coordinateSystem),
        supportedSRSList);
  }
  ...
  public String toString() {
    ...
    sb.append("    supportedSRSList: ").append(toIndentedString(supportedSRSList)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  public static class Builder {
    ...
    public Builder supportedSRSList(
        List<GdalGeometryFieldSupportedSRSListInnerDto> supportedSRSList) {
