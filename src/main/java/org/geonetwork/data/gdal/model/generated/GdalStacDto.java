...
public class GdalStacDto {
  ...
  private JsonNullable<GdalProjjsonschemaDto> projColonProjjson =
      JsonNullable.<GdalProjjsonschemaDto>undefined();

  @Valid private List<Integer> projColonShape = new ArrayList<>();

  @Valid private List<BigDecimal> projColonTransform = new ArrayList<>();
  ...
  @Schema(
      name = "proj:shape",
      description =
          "note that the order of items in proj:shape is height,width starting with GDAL 3.8.5"
  ...
  public String toString() {
    ...
    sb.append("    projColonProjjson: ").append(toIndentedString(projColonProjjson)).append("\n");
    sb.append("    projColonShape: ").append(toIndentedString(projColonShape)).append("\n");
    sb.append("    projColonTransform: ").append(toIndentedString(projColonTransform)).append("\n");
    sb.append("    eoColonBands: ").append(toIndentedString(eoColonBands)).append("\n");
    sb.append("    rasterColonBands: ").append(toIndentedString(rasterColonBands)).append("\n");
    sb.append("}");
    return sb.toString();
  }
