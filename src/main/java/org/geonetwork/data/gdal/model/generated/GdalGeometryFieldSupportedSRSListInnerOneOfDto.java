...
public class GdalGeometryFieldSupportedSRSListInnerOneOfDto
    implements GdalGeometryFieldSupportedSRSListInnerDto {

  private GdalGeometryFieldSupportedSRSListInnerOneOfIdDto id;

  public GdalGeometryFieldSupportedSRSListInnerOneOfDto id(
      GdalGeometryFieldSupportedSRSListInnerOneOfIdDto id) {
    this.id = id;
    return this;
  }
