...
public class OgcApiRecordsCatalog1Dto {
    ...
    @Valid
    private List<@Valid OgcApiRecordsRecordGeoJSONDto> records = new ArrayList<>();
    ...
    public OgcApiRecordsCatalog1Dto(TypeEnum type, String id, List<@Valid OgcApiRecordsLinkBaseDto> links) {
        this.type = type;
        this.id = id;
        this.links = links;
    }
    ...
    public OgcApiRecordsCatalog1Dto resourceLanguages(List<@Valid OgcApiRecordsLanguageDto> resourceLanguages) {
        this.resourceLanguages = resourceLanguages;
        return this;
    }

    public OgcApiRecordsCatalog1Dto addResourceLanguagesItem(OgcApiRecordsLanguageDto resourceLanguagesItem) {
    ...
    public OgcApiRecordsCatalog1Dto addLinkTemplatesItem(OgcApiRecordsLinkTemplateDto linkTemplatesItem) {
    ...
    public String toString() {
        String sb = "class OgcApiRecordsCatalog1Dto {\n"
                + "    conformsTo: "
