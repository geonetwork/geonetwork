...
public class OgcApiRecordsSchemaDto {
    ...
    @Valid
    private List<@Valid OgcApiRecordsServerDto> servers = new ArrayList<>();

    @Valid
    private List<OgcApiRecordsSecurityRequirementDto> security = new ArrayList<>();

    @Valid
    private Set<@Valid OgcApiRecordsTagDto> tags = new LinkedHashSet<>();
    ...
    public String toString() {
        String sb = "class OgcApiRecordsSchemaDto {\n"
                + "    openapi: "
