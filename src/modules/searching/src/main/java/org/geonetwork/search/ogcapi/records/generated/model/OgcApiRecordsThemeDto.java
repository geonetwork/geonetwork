...
public class OgcApiRecordsThemeDto {
    ...
    @Valid
    private List<@Valid OgcApiRecordsThemeConceptsInnerDto> concepts = new ArrayList<>();
    ...
    public OgcApiRecordsThemeDto(List<@Valid OgcApiRecordsThemeConceptsInnerDto> concepts, String scheme) {
    ...
    @Schema(
            name = "concepts",
            description = "One or more entity/concept identifiers from this knowledge system. it is recommended"
    ...
    @Schema(
            name = "scheme",
            description = "An identifier for the knowledge organization system used to classify the resource.  It"
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.concepts, theme.concepts) && Objects.equals(this.scheme, theme.scheme);
    }
    ...
    public String toString() {
        String sb = "class OgcApiRecordsThemeDto {\n"
                + "    concepts: "
