...
@JacksonXmlRootElement(localName = "OgcApiRecordsLanguageDto")
@XmlRootElement(name = "OgcApiRecordsLanguageDto")
@XmlAccessorType(XmlAccessType.FIELD)
@Generated(
        value = "org.openapitools.codegen.languages.SpringCodegen",
        date = "2024-08-01T19:35:56.379122136+02:00[Europe/Paris]",
        comments = "Generator version: 7.7.0")
public class OgcApiRecordsLanguageDto {
    ...
    public OgcApiRecordsLanguageDto() {
        super();
    }

    /** Constructor with only required parameters */
    public OgcApiRecordsLanguageDto(String code) {
        this.code = code;
    }
    ...
    public OgcApiRecordsLanguageDto code(String code) {
        this.code = code;
        return this;
    }
    ...
    public OgcApiRecordsLanguageDto name(String name) {
        this.name = name;
        return this;
    }
    ...
    public OgcApiRecordsLanguageDto alternate(String alternate) {
    ...
    public OgcApiRecordsLanguageDto dir(DirEnum dir) {
        this.dir = dir;
        return this;
    }
    ...
    @Schema(
            name = "dir",
            description = "The direction for text in this language. The default, `ltr` (left-to-right), represents"
    ...
    public boolean equals(Object o) {
        ...
        OgcApiRecordsLanguageDto language = (OgcApiRecordsLanguageDto) o;
    ...
    public String toString() {
        String sb = "class OgcApiRecordsLanguageDto {\n"
                + "    code: "
    ...
    public static class Builder {
        ...
        private OgcApiRecordsLanguageDto instance;

        public Builder() {
            this(new OgcApiRecordsLanguageDto());
        }

        protected Builder(OgcApiRecordsLanguageDto instance) {
            this.instance = instance;
        }

        protected Builder copyOf(OgcApiRecordsLanguageDto value) {
        ...
        /**
         * returns a built OgcApiRecordsLanguageDto instance.
         *
         * <p>The builder is not reusable (NullPointerException)
         */
        public OgcApiRecordsLanguageDto build() {
            try {
