...
public class OgcApiRecordsFeatureCollectionGeoJSONDto {
    ...
    @Valid
    private List<@Valid OgcApiRecordsFeatureGeoJSONDto> features = new ArrayList<>();
    ...
    public OgcApiRecordsFeatureCollectionGeoJSONDto features(List<@Valid OgcApiRecordsFeatureGeoJSONDto> features) {
        this.features = features;
        return this;
    }

    public OgcApiRecordsFeatureCollectionGeoJSONDto addFeaturesItem(OgcApiRecordsFeatureGeoJSONDto featuresItem) {
    ...
    public String toString() {
        String sb = "class OgcApiRecordsFeatureCollectionGeoJSONDto {\n"
                + "    type: "
