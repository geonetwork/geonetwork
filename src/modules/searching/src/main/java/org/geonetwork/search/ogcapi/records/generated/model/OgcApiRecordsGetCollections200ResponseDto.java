...
public class OgcApiRecordsGetCollections200ResponseDto {
    ...
    @Valid
    private List<@Valid Object> collections = new ArrayList<>();
    ...
    public OgcApiRecordsGetCollections200ResponseDto linkTemplates(List<OgcApiRecordsLinkTemplateDto> linkTemplates) {
    ...
    public String toString() {
        String sb = "class OgcApiRecordsGetCollections200ResponseDto {\n"
                + "    links: "
