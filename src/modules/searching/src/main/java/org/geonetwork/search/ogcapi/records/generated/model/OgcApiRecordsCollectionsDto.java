...
public class OgcApiRecordsCollectionsDto {
    ...
    @Valid
    private List<@Valid OgcApiRecordsCollectionDto> collections = new ArrayList<>();
    ...
    public OgcApiRecordsCollectionsDto(
            List<@Valid OgcApiRecordsLinkDto> links, List<@Valid OgcApiRecordsCollectionDto> collections) {
        this.links = links;
    ...
    public OgcApiRecordsCollectionsDto collections(List<@Valid OgcApiRecordsCollectionDto> collections) {
        this.collections = collections;
        return this;
    }

    public OgcApiRecordsCollectionsDto addCollectionsItem(OgcApiRecordsCollectionDto collectionsItem) {
    ...
    public String toString() {
        String sb = "class OgcApiRecordsCollectionsDto {\n"
                + "    links: "
