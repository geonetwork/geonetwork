...
public class OgcApiRecordsLinkTemplateDto {
    ...
    @Schema(
            name = "varBase",
            description = "The base URI to which the variable name can be appended to retrieve the definition of"
    ...
    @Schema(
            name = "variables",
            description = "This object contains one key per substitution variable in the templated URL.  Each key"
    ...
    public String toString() {
        String sb = "class OgcApiRecordsLinkTemplateDto {\n"
                + "    rel: "
