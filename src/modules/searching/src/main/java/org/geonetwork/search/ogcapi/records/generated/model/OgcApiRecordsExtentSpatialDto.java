...
public class OgcApiRecordsExtentSpatialDto {
  ...
  @Valid private List<OgcApiRecordsExtentSpatialBboxInnerDto> bbox = new ArrayList<>();
  ...
  public OgcApiRecordsExtentSpatialDto addBboxItem(
      OgcApiRecordsExtentSpatialBboxInnerDto bboxItem) {
    if (this.bbox == null) {
  ...
  public String toString() {
    String sb =
        "class OgcApiRecordsExtentSpatialDto {\n"
            + "    bbox: "
