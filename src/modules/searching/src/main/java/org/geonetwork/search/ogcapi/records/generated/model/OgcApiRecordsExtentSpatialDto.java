...
@Schema(name = "extent_spatial", description = "The spatial extent of the features in the collection.")
@JsonTypeName("extent_spatial")
@JacksonXmlRootElement(localName = "OgcApiRecordsExtentSpatialDto")
@XmlRootElement(name = "OgcApiRecordsExtentSpatialDto")
@XmlAccessorType(XmlAccessType.FIELD)
@Generated(
        value = "org.openapitools.codegen.languages.SpringCodegen",
        date = "2024-08-01T19:35:56.379122136+02:00[Europe/Paris]",
        comments = "Generator version: 7.7.0")
public class OgcApiRecordsExtentSpatialDto {

    @Valid
    private List<OgcApiRecordsExtentSpatialBboxInnerDto> bbox = new ArrayList<>();
    ...
    public OgcApiRecordsExtentSpatialDto bbox(List<OgcApiRecordsExtentSpatialBboxInnerDto> bbox) {
        this.bbox = bbox;
        return this;
    }

    public OgcApiRecordsExtentSpatialDto addBboxItem(OgcApiRecordsExtentSpatialBboxInnerDto bboxItem) {
        if (this.bbox == null) {
    ...
    @Schema(
            name = "bbox",
            description = "One or more bounding boxes that describe the spatial extent of the dataset. In the Core"
    ...
    public List<OgcApiRecordsExtentSpatialBboxInnerDto> getBbox() {
        return bbox;
    }

    public void setBbox(List<OgcApiRecordsExtentSpatialBboxInnerDto> bbox) {
        this.bbox = bbox;
    }

    public OgcApiRecordsExtentSpatialDto crs(CrsEnum crs) {
        this.crs = crs;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        OgcApiRecordsExtentSpatialDto extentSpatial = (OgcApiRecordsExtentSpatialDto) o;
    ...
    public String toString() {
        String sb = "class OgcApiRecordsExtentSpatialDto {\n"
                + "    bbox: "
    ...
    public static class Builder {
        ...
        private OgcApiRecordsExtentSpatialDto instance;

        public Builder() {
            this(new OgcApiRecordsExtentSpatialDto());
        }

        protected Builder(OgcApiRecordsExtentSpatialDto instance) {
            this.instance = instance;
        }

        protected Builder copyOf(OgcApiRecordsExtentSpatialDto value) {
            this.instance.setBbox(value.bbox);
            this.instance.setCrs(value.crs);
            return this;
        }

        public Builder bbox(List<OgcApiRecordsExtentSpatialBboxInnerDto> bbox) {
        ...
        /**
         * returns a built OgcApiRecordsExtentSpatialDto instance.
         *
         * <p>The builder is not reusable (NullPointerException)
         */
        public OgcApiRecordsExtentSpatialDto build() {
            try {
