...
public class GdalCoordinateSystemDto {
  ...
  @Valid private List<BigDecimal> dataAxisToSRSAxisMapping = new ArrayList<>();
  ...
  public GdalCoordinateSystemDto dataAxisToSRSAxisMapping(
      List<BigDecimal> dataAxisToSRSAxisMapping) {
    this.dataAxisToSRSAxisMapping = dataAxisToSRSAxisMapping;
    return this;
  }

  public GdalCoordinateSystemDto addDataAxisToSRSAxisMappingItem(
      BigDecimal dataAxisToSRSAxisMappingItem) {
  ...
  public String toString() {
    ...
    sb.append("    dataAxisToSRSAxisMapping: ")
        ...
        .append("\n");
    sb.append("    coordinateEpoch: ").append(toIndentedString(coordinateEpoch)).append("\n");
    sb.append("}");
    return sb.toString();
  }
