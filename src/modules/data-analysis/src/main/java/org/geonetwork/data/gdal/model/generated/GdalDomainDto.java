...
public class GdalDomainDto {
  ...
  public GdalDomainDto(
      TypeEnum type,
      GdalFieldTypeDto fieldType,
      SplitPolicyEnum splitPolicy,
      MergePolicyEnum mergePolicy) {
    this.type = type;
  ...
  public String toString() {
    ...
    sb.append("    minValueIncluded: ").append(toIndentedString(minValueIncluded)).append("\n");
    sb.append("    maxValue: ").append(toIndentedString(maxValue)).append("\n");
    sb.append("    maxValueIncluded: ").append(toIndentedString(maxValueIncluded)).append("\n");
    sb.append("}");
    return sb.toString();
  }
