...
import org.geonetwork.metadata.editing.model.Direction;
...
public class EditingController {
    ...
    public String startEditing(
            ...
            throws Exception {
        Metadata metadata = metadataManager.findMetadataByUuid(metadataUuid, false);
        metadataAccessManager.canEdit(metadata.getId());
    ...
    public void saveEdits(
        ...
        if (StringUtils.isNotEmpty(data)) {
            ...
            metadataManager.update(metadata.getId(), md, withValidationErrors, ufo, changeDate, updateDateStamp);
