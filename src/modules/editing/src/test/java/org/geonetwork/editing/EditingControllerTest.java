...
import static org.geonetwork.metadata.editing.EditUtils.ID;
import static org.geonetwork.metadata.editing.EditUtils.VERSION;
...
class EditingControllerTest {
    ...
    public void testEditing() throws Exception {
        ...
        Object o = Xml.selectSingle(
                ...
                schemaManager.getSchema(schema).getAllNamespaces().stream().toList());
        ...
        if (o instanceof Element description) {
            ...
            assertEquals(
                    ...
                    Xml.selectNodes(
                                    ...
                                    XPATH_ISO191153_ABSTRACT,
                                    schemaManager.getSchema(schema).getAllNamespaces().stream()
                                            .toList())
                            .size());
        }
