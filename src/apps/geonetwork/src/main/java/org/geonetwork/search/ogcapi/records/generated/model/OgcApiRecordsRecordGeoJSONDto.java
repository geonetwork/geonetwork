...
public class OgcApiRecordsRecordGeoJSONDto {
  ...
  public OgcApiRecordsRecordGeoJSONDto properties(
      OgcApiRecordsRecordGeoJSONPropertiesDto properties) {
    this.properties = properties;
    return this;
  }
  ...
  public OgcApiRecordsRecordGeoJSONDto linkTemplates(
      List<OgcApiRecordsLinkTemplateDto> linkTemplates) {
    this.linkTemplates = linkTemplates;
    return this;
  }

  public OgcApiRecordsRecordGeoJSONDto addLinkTemplatesItem(
  ...
  public String toString() {
    String sb =
        "class OgcApiRecordsRecordGeoJSONDto {\n"
            + "    id: "
            + toIndentedString(id)
            + "\n"
            + "    type: "
