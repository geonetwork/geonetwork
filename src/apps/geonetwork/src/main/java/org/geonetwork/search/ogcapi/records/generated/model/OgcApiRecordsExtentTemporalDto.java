...
public class OgcApiRecordsExtentTemporalDto {
  ...
  @Valid private List<List<OffsetDateTime>> interval = new ArrayList<>();
  ...
  @Schema(
      name = "interval",
      description =
          "One or more time intervals that describe the temporal extent of the dataset. In the Core"
  ...
  public String toString() {
    String sb =
        "class OgcApiRecordsExtentTemporalDto {\n"
            + "    interval: "
   ...
   */
  public enum TrsEnum {
    HTTP_WWW_OPENGIS_NET_DEF_UOM_ISO_8601_0_GREGORIAN(
