...
public class ISO19115_3Namespaces {
  ...
  public static final Namespace MRI =
      Namespace.getNamespace("mri", "http://standards.iso.org/iso/19115/-3/mri/1.0");
  public static final Namespace CIT =
      Namespace.getNamespace("cit", "http://standards.iso.org/iso/19115/-3/cit/2.0");
  public static final Namespace SRV =
      Namespace.getNamespace("srv", "http://standards.iso.org/iso/19115/-3/srv/2.0");
  public static final Namespace GEX =
      Namespace.getNamespace("gex", "http://standards.iso.org/iso/19115/-3/gex/1.0");
  public static final Namespace MRC =
      Namespace.getNamespace("mrc", "http://standards.iso.org/iso/19115/-3/mrc/2.0");
  public static final Namespace MRL =
      Namespace.getNamespace("mrl", "http://standards.iso.org/iso/19115/-3/mrl/2.0");
  public static final Namespace LAN =
      Namespace.getNamespace("lan", "http://standards.iso.org/iso/19115/-3/lan/1.0");
  public static final Namespace GCX =
      Namespace.getNamespace("gcx", "http://standards.iso.org/iso/19115/-3/gcx/1.0");
