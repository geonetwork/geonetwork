...
public class GdalVerticalCrsDto implements GdalCrsDto {
  ...
  @Valid private List<@Valid GdalGeoidModelDto> geoidModels = new ArrayList<>();
  ...
  public GdalVerticalCrsDto deformationModels(
      List<@Valid GdalDeformationModelDto> deformationModels) {
    this.deformationModels = deformationModels;
    return this;
  }

  public GdalVerticalCrsDto addDeformationModelsItem(
