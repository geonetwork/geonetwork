...
public class OgcApiRecordsMultipolygonGeoJSONDto implements OgcApiRecordsGeometryGeoJSONDto {
  ...
  public OgcApiRecordsMultipolygonGeoJSONDto(
      TypeEnum type, List<List<List<List<BigDecimal>>>> coordinates) {
    this.type = type;
  ...
  public OgcApiRecordsMultipolygonGeoJSONDto coordinates(
      List<List<List<List<BigDecimal>>>> coordinates) {
    this.coordinates = coordinates;
    return this;
  }

  public OgcApiRecordsMultipolygonGeoJSONDto addCoordinatesItem(
  ...
  public boolean equals(Object o) {
    ...
    OgcApiRecordsMultipolygonGeoJSONDto multipolygonGeoJSON =
        (OgcApiRecordsMultipolygonGeoJSONDto) o;
  ...
  public String toString() {
    String sb =
        "class OgcApiRecordsMultipolygonGeoJSONDto {\n"
            + "    type: "
