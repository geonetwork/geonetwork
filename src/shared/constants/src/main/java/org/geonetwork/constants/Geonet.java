...
public final class Geonet {
  ...
  public static final String CC_API_REST_URL =
      "http://api.creativecommons.org/rest/1.5/simple/chooser";
  ...
  public static final class Namespaces {
    ...
    public static final Namespace XSL =
        Namespace.getNamespace("xsl", "http://www.w3.org/1999/XSL/Transform");
    public static final Namespace XSD =
        Namespace.getNamespace("xsd", XMLConstants.W3C_XML_SCHEMA_NS_URI);
    ...
    public static final Namespace GML32 =
        Namespace.getNamespace("gml", "http://www.opengis.net/gml/3.2");
    public static final Namespace SVRL =
        Namespace.getNamespace("svrl", "http://purl.oclc.org/dsdl/svrl");
