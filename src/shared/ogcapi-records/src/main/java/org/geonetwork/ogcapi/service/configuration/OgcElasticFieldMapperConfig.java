...
public class OgcElasticFieldMapperConfig {
  ...
  /**
   *  user-overrided type.  Typically, to return either a list of (type) (`List<String>`)  or a single-value type (`String`).
   * Differentiating between them from the elastic index definition isn't really possible.
   */
  ...
  public String title;
    ...
    /**
     * add to the JSON ogc output?
     *  usually, you do.  However, you might not want to if you  already have a pre-defined property
     *  that you want to use in facets.
     */
