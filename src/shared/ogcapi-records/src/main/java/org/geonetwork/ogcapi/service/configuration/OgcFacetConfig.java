...
public class OgcFacetConfig {
  ...
  public BucketSorting bucketSorting = BucketSorting.COUNT;
    ...
    /**
     * buckets with <minimumDocumentCount will be removed. Usually 0 (dont remove any buckets) or 1 (remove empty buckets).
     * Typically, you don't want to show empty buckets.
     */
