 ...
 *
 * <p>Created by francois on 3/26/14.
 */
public class ISO19139Namespaces {
    ...
    public static final Namespace GML320 = Namespace.getNamespace("gml", "http://www.opengis.net/gml");
    public static final Namespace XSI = Namespace.getNamespace("xsi", "http://www.w3.org/2001/XMLSchema-instance");
    public static final Namespace GTS = Namespace.getNamespace("gts", "http://www.isotc211.org/2005/gts");
