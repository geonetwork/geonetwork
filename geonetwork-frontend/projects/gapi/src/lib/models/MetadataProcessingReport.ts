...
/**
 * Check if a given object implements the MetadataProcessingReport interface.
 */
export function instanceOfMetadataProcessingReport(
  value: object
): value is MetadataProcessingReport {
  return true;
}

export function MetadataProcessingReportFromJSON(
  json: any
): MetadataProcessingReport {
  return MetadataProcessingReportFromJSONTyped(json, false);
}

export function MetadataProcessingReportFromJSONTyped(
  json: any,
...
export function MetadataProcessingReportToJSON(
  value?: MetadataProcessingReport | null
): any {
  if (value == null) {
    return value;
  }
