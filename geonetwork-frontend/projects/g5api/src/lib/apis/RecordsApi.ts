...
export class RecordsApi extends runtime.BaseAPI {
    ...
    async delResourceRaw(requestParameters: DelResourceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        ...
        const response = await this.request({
            path: `/api/records/{metadataUuidOrId}/attachments/{resourceId}`.replace(`{${"metadataUuidOrId"}}`, encodeURIComponent(String(requestParameters['metadataUuidOrId']))).replace(`{${"resourceId"}}`, encodeURIComponent(String(requestParameters['resourceId']))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async delResourcesRaw(requestParameters: DelResourcesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        ...
        const response = await this.request({
            path: `/api/records/{metadataUuidOrId}/attachments`.replace(`{${"metadataUuidOrId"}}`, encodeURIComponent(String(requestParameters['metadataUuidOrId']))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
