...
export class DataAnalysisControllerApi extends runtime.BaseAPI {
  ...
  /**
   */
  async analysisSynchIndexRecordRaw(
    requestParameters: AnalysisSynchIndexRecordRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ...
  /**
   */
  async analysisSynchIndexRecord(
    requestParameters: AnalysisSynchIndexRecordRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<IndexRecord> {
    const response = await this.analysisSynchIndexRecordRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
