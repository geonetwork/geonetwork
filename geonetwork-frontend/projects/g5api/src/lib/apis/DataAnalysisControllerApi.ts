...
export interface AnalysisSynchIndexRecordRequest {
    datasource: string;
    layer: string;
}
...
export class DataAnalysisControllerApi extends runtime.BaseAPI {
    ...
    /**
     */
    async analysisSynchIndexRecordRaw(requestParameters: AnalysisSynchIndexRecordRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<IndexRecord>> {
        if (requestParameters['datasource'] == null) {
            throw new runtime.RequiredError(
                'datasource',
                'Required parameter "datasource" was null or undefined when calling analysisSynchIndexRecord().'
            );
        }
        ...
        if (requestParameters['layer'] == null) {
            throw new runtime.RequiredError(
                'layer',
                'Required parameter "layer" was null or undefined when calling analysisSynchIndexRecord().'
            );
        }
        ...
        const response = await this.request({
            path: `/api/data/analysis/executeIndexRecord`,
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    /**
     */
    async analysisSynchIndexRecord(requestParameters: AnalysisSynchIndexRecordRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<IndexRecord> {
        const response = await this.analysisSynchIndexRecordRaw(requestParameters, initOverrides);
        return await response.value();
    }
