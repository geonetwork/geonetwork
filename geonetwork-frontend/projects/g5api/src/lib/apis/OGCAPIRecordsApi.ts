...
export class OGCAPIRecordsApi extends runtime.BaseAPI {
  ...
  async describeCollectionRaw(
  ...
  ): Promise<runtime.ApiResponse<OgcApiRecordsCatalog1Dto>> {
    ...
    const response = await this.request(
      {
        path: `/ogcapi/records/collections/{catalogId}`.replace(
          `{${'catalogId'}}`,
    ...
    return new runtime.JSONApiResponse(response, jsonValue =>
      OgcApiRecordsCatalog1DtoFromJSON(jsonValue)
    );
  }
  ...
  async describeCollection(
    requestParameters: DescribeCollectionRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<OgcApiRecordsCatalog1Dto> {
   ...
   */
  async getCollectionsRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<OgcApiRecordsGetCollections200ResponseDto>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, jsonValue =>
      OgcApiRecordsGetCollections200ResponseDtoFromJSON(jsonValue)
    );
  }
  ...
  async getCollections(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<OgcApiRecordsGetCollections200ResponseDto> {
   ...
   */
  async getConformanceDeclarationRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<OgcApiRecordsConfClassesDto>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, jsonValue =>
      OgcApiRecordsConfClassesDtoFromJSON(jsonValue)
    );
  }
   ...
   * information about specifications that this API conforms to
   */
  async getConformanceDeclaration(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<OgcApiRecordsConfClassesDto> {
   ...
   * landing page
   */
  async getLandingPageRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<OgcApiRecordsLandingPageDto>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, jsonValue =>
      OgcApiRecordsLandingPageDtoFromJSON(jsonValue)
    );
  }
  ...
  async getLandingPage(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<OgcApiRecordsLandingPageDto> {
  ...
  async getRecordRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<OgcApiRecordsRecordGeoJSONDto>> {
    if (requestParameters['catalogId'] == null) {
      throw new runtime.RequiredError(
        'catalogId',
    ...
    const response = await this.request(
      {
        path: `/ogcapi/records/collections/{catalogId}/items/{recordId}`
          .replace(
            `{${'catalogId'}}`,
            encodeURIComponent(String(requestParameters['catalogId']))
          )
    ...
    return new runtime.JSONApiResponse(response, jsonValue =>
      OgcApiRecordsRecordGeoJSONDtoFromJSON(jsonValue)
    );
  }
  ...
  async getRecord(
    requestParameters: GetRecordRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<OgcApiRecordsRecordGeoJSONDto> {
   ...
   */
  async getRecordsRaw(
    requestParameters: GetRecordsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<OgcApiRecordsGetRecords200ResponseDto>> {
    if (requestParameters['catalogId'] == null) {
      throw new runtime.RequiredError(
        'catalogId',
    ...
    const response = await this.request(
      {
        path: `/ogcapi/records/collections/{catalogId}/items`.replace(
          `{${'catalogId'}}`,
          encodeURIComponent(String(requestParameters['catalogId']))
        ),
        method: 'GET',
    ...
    return new runtime.JSONApiResponse(response, jsonValue =>
      OgcApiRecordsGetRecords200ResponseDtoFromJSON(jsonValue)
    );
  }
  ...
  async getRecords(
    requestParameters: GetRecordsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<OgcApiRecordsGetRecords200ResponseDto> {
   ...
   */
  async getSortablesRaw(
    requestParameters: GetSortablesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
    ...
    const response = await this.request(
      {
        path: `/ogcapi/records/collections/{catalogId}/sortables`.replace(
          `{${'catalogId'}}`,
          encodeURIComponent(String(requestParameters['catalogId']))
        ),
        method: 'GET',
  ...
  async getSortables(
    ...
    const response = await this.getSortablesRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
