...
import type { GnRasterCornerCoordinates } from './GnGnRasterCornerCoordinates';
import {
    GnRasterCornerCoordinatesFromJSON,
    GnRasterCornerCoordinatesFromJSONTyped,
    GnRasterCornerCoordinatesToJSON,
} from './GnGnRasterCornerCoordinates';
import type { GnRasterBand } from './GnGnRasterBand';
import {
    GnRasterBandFromJSON,
    GnRasterBandFromJSONTyped,
    GnRasterBandToJSON,
} from './GnGnRasterBand';
...
export type GnRasterInfoDataTypeEnum = typeof GnRasterInfoDataTypeEnum[keyof typeof GnRasterInfoDataTypeEnum];
...
export function GnRasterInfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): GnRasterInfo {
    if (json == null) {
        return json;
    }
    return {
        ...
        'rasterCornerCoordinates': json['rasterCornerCoordinates'] == null ? undefined : GnRasterCornerCoordinatesFromJSON(json['rasterCornerCoordinates']),
        'metadata': json['metadata'] == null ? undefined : json['metadata'],
        'size': json['size'] == null ? undefined : json['size'],
        'bands': json['bands'] == null ? undefined : ((json['bands'] as Array<any>).map(GnRasterBandFromJSON)),
    };
}
...
export function GnRasterInfoToJSON(value?: GnRasterInfo | null): any {
    ...
    return {
        ...
        'rasterCornerCoordinates': GnRasterCornerCoordinatesToJSON(value['rasterCornerCoordinates']),
        'metadata': value['metadata'],
        'size': value['size'],
        'bands': value['bands'] == null ? undefined : ((value['bands'] as Array<any>).map(GnRasterBandToJSON)),
    };
}
