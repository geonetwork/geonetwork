 ...
 */
export function instanceOfOgcApiRecordsRecordGeoJSONPropertiesDto(value: object): value is OgcApiRecordsRecordGeoJSONPropertiesDto {
    return true;
}

export function OgcApiRecordsRecordGeoJSONPropertiesDtoFromJSON(json: any): OgcApiRecordsRecordGeoJSONPropertiesDto {
    return OgcApiRecordsRecordGeoJSONPropertiesDtoFromJSONTyped(json, false);
}

export function OgcApiRecordsRecordGeoJSONPropertiesDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): OgcApiRecordsRecordGeoJSONPropertiesDto {
    if (json == null) {
        return json;
    }
    return {
...
export function OgcApiRecordsRecordGeoJSONPropertiesDtoToJSON(value?: OgcApiRecordsRecordGeoJSONPropertiesDto | null): any {
    if (value == null) {
        return value;
    }
    return {
