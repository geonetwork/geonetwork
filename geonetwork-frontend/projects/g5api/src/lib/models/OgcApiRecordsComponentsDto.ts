 ...
 */
export function instanceOfOgcApiRecordsComponentsDto(
  value: object
): value is OgcApiRecordsComponentsDto {
  return true;
}

export function OgcApiRecordsComponentsDtoFromJSON(
  json: any
): OgcApiRecordsComponentsDto {
  return OgcApiRecordsComponentsDtoFromJSONTyped(json, false);
}

export function OgcApiRecordsComponentsDtoFromJSONTyped(
  json: any,
...
export function OgcApiRecordsComponentsDtoToJSON(
  value?: OgcApiRecordsComponentsDto | null
): any {
  if (value == null) {
    return value;
  }
