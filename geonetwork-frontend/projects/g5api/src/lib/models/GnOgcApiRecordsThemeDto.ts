 ...
 */
export function instanceOfGnOgcApiRecordsThemeDto(
  value: object
): value is GnOgcApiRecordsThemeDto {
  if (!('concepts' in value) || value['concepts'] === undefined) return false;
  if (!('scheme' in value) || value['scheme'] === undefined) return false;
  return true;
}

export function GnOgcApiRecordsThemeDtoFromJSON(
  json: any
): GnOgcApiRecordsThemeDto {
  return GnOgcApiRecordsThemeDtoFromJSONTyped(json, false);
}

export function GnOgcApiRecordsThemeDtoFromJSONTyped(
  json: any,
  ...
  return {
    concepts: (json['concepts'] as Array<any>).map(
      GnOgcApiRecordsThemeConceptsInnerDtoFromJSON
    ),
    scheme: json['scheme'],
  };
...
export function GnOgcApiRecordsThemeDtoToJSON(
  value?: GnOgcApiRecordsThemeDto | null
): any {
  if (value == null) {
    return value;
  }
  return {
    concepts: (value['concepts'] as Array<any>).map(
      GnOgcApiRecordsThemeConceptsInnerDtoToJSON
    ),
    scheme: value['scheme'],
  };
