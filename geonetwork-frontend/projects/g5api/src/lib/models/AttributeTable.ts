 ...
 */
export function instanceOfAttributeTable(value: object): value is AttributeTable {
    return true;
}
...
export function AttributeTableFromJSONTyped(json: any, ignoreDiscriminator: boolean): AttributeTable {
    if (json == null) {
        return json;
    }
    return {
        ...
        'values': json['values'] == null ? undefined : ((json['values'] as Array<any>).map(CodeListValueFromJSON)),
    };
}
...
export function AttributeTableToJSON(value?: AttributeTable | null): any {
    ...
    return {
        ...
        'values': value['values'] == null ? undefined : ((value['values'] as Array<any>).map(CodeListValueToJSON)),
    };
}
