 ...
 */
export function instanceOfGnOgcApiRecordsGetCollections200ResponseDto(
  value: object
): value is GnOgcApiRecordsGetCollections200ResponseDto {
...
export function GnOgcApiRecordsGetCollections200ResponseDtoFromJSON(
  json: any
): GnOgcApiRecordsGetCollections200ResponseDto {
  return GnOgcApiRecordsGetCollections200ResponseDtoFromJSONTyped(json, false);
}

export function GnOgcApiRecordsGetCollections200ResponseDtoFromJSONTyped(
  json: any,
...
export function GnOgcApiRecordsGetCollections200ResponseDtoToJSON(
  value?: GnOgcApiRecordsGetCollections200ResponseDto | null
): any {
  if (value == null) {
    return value;
  }
