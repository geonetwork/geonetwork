...
import { GnLinkFromJSON, GnLinkFromJSONTyped, GnLinkToJSON } from './GnGnLink';
  ...
  return {
    ...
    maintenance:
      json['maintenance'] == null
        ? undefined
        : (json['maintenance'] as Array<any>).map(GnMaintenanceFromJSON),
  ...
  return {
    ...
    maintenance:
      value['maintenance'] == null
        ? undefined
        : (value['maintenance'] as Array<any>).map(GnMaintenanceToJSON),
