 ...
 */
export function instanceOfGnOgcApiRecordsLinkBaseDto(
  value: object
): value is GnOgcApiRecordsLinkBaseDto {
  return true;
}

export function GnOgcApiRecordsLinkBaseDtoFromJSON(
  json: any
): GnOgcApiRecordsLinkBaseDto {
  return GnOgcApiRecordsLinkBaseDtoFromJSONTyped(json, false);
}

export function GnOgcApiRecordsLinkBaseDtoFromJSONTyped(
  json: any,
...
export function GnOgcApiRecordsLinkBaseDtoToJSON(
  value?: GnOgcApiRecordsLinkBaseDto | null
): any {
  if (value == null) {
    return value;
  }
