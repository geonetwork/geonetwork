...
export type MetadataResourceVisibilityEnum = typeof MetadataResourceVisibilityEnum[keyof typeof MetadataResourceVisibilityEnum];


/**
 * Check if a given object implements the MetadataResource interface.
 */
export function instanceOfMetadataResource(value: object): value is MetadataResource {
    return true;
}
...
export function MetadataResourceFromJSONTyped(json: any, ignoreDiscriminator: boolean): MetadataResource {
    if (json == null) {
        return json;
    }
    return {
        ...
        'metadataResourceExternalManagementProperties': json['metadataResourceExternalManagementProperties'] == null ? undefined : MetadataResourceExternalManagementPropertiesFromJSON(json['metadataResourceExternalManagementProperties']),
...
export function MetadataResourceToJSON(value?: MetadataResource | null): any {
    ...
    return {
        ...
        'url': value['url'],
        'metadataResourceExternalManagementProperties': MetadataResourceExternalManagementPropertiesToJSON(value['metadataResourceExternalManagementProperties']),
