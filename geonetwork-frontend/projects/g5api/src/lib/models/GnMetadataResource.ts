...
export type GnMetadataResourceVisibilityEnum = typeof GnMetadataResourceVisibilityEnum[keyof typeof GnMetadataResourceVisibilityEnum];


/**
 * Check if a given object implements the GnMetadataResource interface.
 */
export function instanceOfGnMetadataResource(value: object): value is GnMetadataResource {
    return true;
}
...
export function GnMetadataResourceFromJSONTyped(json: any, ignoreDiscriminator: boolean): GnMetadataResource {
    if (json == null) {
        return json;
    }
    return {
        ...
        'lastModification': json['lastModification'] == null ? undefined : (new Date(json['lastModification'])),
        'metadataResourceExternalManagementProperties': json['metadataResourceExternalManagementProperties'] == null ? undefined : GnMetadataResourceExternalManagementPropertiesFromJSON(json['metadataResourceExternalManagementProperties']),
        ...
        'metadataUuid': json['metadataUuid'] == null ? undefined : json['metadataUuid'],
    };
}

export function GnMetadataResourceToJSON(value?: GnMetadataResource | null): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'url': value['url'],
        'lastModification': value['lastModification'] == null ? undefined : ((value['lastModification']).toISOString()),
        'metadataResourceExternalManagementProperties': GnMetadataResourceExternalManagementPropertiesToJSON(value['metadataResourceExternalManagementProperties']),
