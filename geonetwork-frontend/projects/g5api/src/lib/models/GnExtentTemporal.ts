...
export type GnExtentTemporalTrsEnum = typeof GnExtentTemporalTrsEnum[keyof typeof GnExtentTemporalTrsEnum];


/**
 * Check if a given object implements the GnExtentTemporal interface.
 */
export function instanceOfGnExtentTemporal(value: object): value is GnExtentTemporal {
    return true;
}
...
export function GnExtentTemporalFromJSONTyped(json: any, ignoreDiscriminator: boolean): GnExtentTemporal {
    if (json == null) {
        return json;
    }
    return {
