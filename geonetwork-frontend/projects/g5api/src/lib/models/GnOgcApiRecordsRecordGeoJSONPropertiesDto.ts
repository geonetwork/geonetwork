 ...
 */
export function instanceOfGnOgcApiRecordsRecordGeoJSONPropertiesDto(
  value: object
): value is GnOgcApiRecordsRecordGeoJSONPropertiesDto {
  return true;
}

export function GnOgcApiRecordsRecordGeoJSONPropertiesDtoFromJSON(
  json: any
): GnOgcApiRecordsRecordGeoJSONPropertiesDto {
  return GnOgcApiRecordsRecordGeoJSONPropertiesDtoFromJSONTyped(json, false);
}

export function GnOgcApiRecordsRecordGeoJSONPropertiesDtoFromJSONTyped(
  json: any,
...
export function GnOgcApiRecordsRecordGeoJSONPropertiesDtoToJSON(
  value?: GnOgcApiRecordsRecordGeoJSONPropertiesDto | null
): any {
  if (value == null) {
    return value;
  }
