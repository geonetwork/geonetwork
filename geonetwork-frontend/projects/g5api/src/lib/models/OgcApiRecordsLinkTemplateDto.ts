 ...
 */
export function instanceOfOgcApiRecordsLinkTemplateDto(
  value: object
): value is OgcApiRecordsLinkTemplateDto {
  if (!('uriTemplate' in value) || value['uriTemplate'] === undefined)
    return false;
  return true;
}

export function OgcApiRecordsLinkTemplateDtoFromJSON(
  json: any
): OgcApiRecordsLinkTemplateDto {
  return OgcApiRecordsLinkTemplateDtoFromJSONTyped(json, false);
}

export function OgcApiRecordsLinkTemplateDtoFromJSONTyped(
  json: any,
...
export function OgcApiRecordsLinkTemplateDtoToJSON(
  value?: OgcApiRecordsLinkTemplateDto | null
): any {
  if (value == null) {
    return value;
  }
