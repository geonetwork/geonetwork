...
export type RasterInfoDataTypeEnum = typeof RasterInfoDataTypeEnum[keyof typeof RasterInfoDataTypeEnum];
...
export function RasterInfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): RasterInfo {
    if (json == null) {
        return json;
    }
    return {
        ...
        'rasterCornerCoordinates': json['rasterCornerCoordinates'] == null ? undefined : RasterCornerCoordinatesFromJSON(json['rasterCornerCoordinates']),
        'metadata': json['metadata'] == null ? undefined : json['metadata'],
        'size': json['size'] == null ? undefined : json['size'],
        'bands': json['bands'] == null ? undefined : ((json['bands'] as Array<any>).map(RasterBandFromJSON)),
    };
}
...
export function RasterInfoToJSON(value?: RasterInfo | null): any {
    ...
    return {
        ...
        'rasterCornerCoordinates': RasterCornerCoordinatesToJSON(value['rasterCornerCoordinates']),
        'metadata': value['metadata'],
        'size': value['size'],
        'bands': value['bands'] == null ? undefined : ((value['bands'] as Array<any>).map(RasterBandToJSON)),
    };
}
