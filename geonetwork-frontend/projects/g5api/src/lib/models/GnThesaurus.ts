...
export function GnThesaurusFromJSONTyped(json: any, ignoreDiscriminator: boolean): GnThesaurus {
    if (json == null) {
        return json;
    }
    return {
        ...
        'multilingualTitle': json['multilingualTitle'] == null ? undefined : json['multilingualTitle'],
